...
export const OutputPanel = ({
  ...
  useEffect(() => {
    ...
    const hasAnyFileSelected = () => {
      const specific = document.querySelector('[data-slot="upload-input"]') as HTMLInputElement | null
    ...
    const computeEnabled = () => {
      const e2eInvoked = typeof window !== 'undefined' && (((window as any).__e2eUploadInvokeCount ?? 0) > 0)
      const enabled = hasInput || domHasInput || domHasFile || hasAnyFileSelected() || tableData.length > 0 || e2eInvoked
      if (dbg) {
