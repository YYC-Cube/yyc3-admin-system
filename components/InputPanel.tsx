    ...
    <div className="space-y-6">
      <div className="flex flex-wrap gap-3">
        <Select value={selectedFormat} onValueChange={setSelectedFormat}>
          <SelectTrigger
            className="w-40 h-10 bg-card border-border hover:border-ring transition-colors"
        ...
        <Button
          ...
          className="bg-linear-to-r from-green-500 to-green-600 text-white border-0 hover:from-green-600 hover:to-green-700 shadow-lg hover:shadow-xl transition-all duration-200"
        ...
        <Button
          ...
          className="bg-linear-to-r from-blue-500 to-blue-600 text-white border-0 hover:from-blue-600 hover:to-blue-700 shadow-lg hover:shadow-xl transition-all duration-200"
        ...
        <Button
          ...
          size="lg"
          onClick={onClear}
          className="bg-linear-to-r from-red-500 to-red-600 text-white border-0 hover:from-red-600 hover:to-red-700 shadow-lg hover:shadow-xl transition-all duration-200"
      ...
      />
      {/* 仅在提供了 onParse 和 onReset 时显示底部按钮组 */}
      {(onParse || onReset) && (
        <div className="flex items-center gap-3">
          {onParse && (
            <Button
              className="bg-linear-to-r from-primary to-primary/80 text-primary-foreground hover:from-primary/90 hover:to-primary/90"
              onClick={onParse}
            >
              {t('actions.parse')}
            </Button>
          ...
          <Button
            className="bg-linear-to-r from-secondary to-secondary/80 text-secondary-foreground hover:from-secondary/90 hover:to-secondary/90"
            onClick={onClear}
          >
            {t('actions.clear')}
          </Button>
