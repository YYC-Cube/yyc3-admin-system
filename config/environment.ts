...
function parseFormatsStrict(val: string | undefined, fallback: readonly string[], known: readonly string[]): readonly string[] {
...
const maxUploadSize = enforceBounds('API_MAX_UPLOAD_SIZE', toInt(env.API_MAX_UPLOAD_SIZE, DEFAULTS.api.maxUploadSize))
const timeoutMs = enforceBounds('API_TIMEOUT_MS', toInt(env.API_TIMEOUT_MS, DEFAULTS.api.timeoutMs))
const rateWindowMs = enforceBounds('API_RATE_WINDOW_MS', toInt(env.API_RATE_WINDOW_MS, DEFAULTS.api.rateLimit.windowMs))
const rateMaxPerIp = enforceBounds('API_RATE_MAX_PER_IP', toInt(env.API_RATE_MAX_PER_IP, DEFAULTS.api.rateLimit.maxPerIp))
const concMaxPerIp = enforceBounds('API_CONCURRENCY_MAX_PER_IP', toInt(env.API_CONCURRENCY_MAX_PER_IP, DEFAULTS.api.concurrency.maxPerIp))
const concMaxTotal = enforceBounds('API_CONCURRENCY_MAX_TOTAL', toInt(env.API_CONCURRENCY_MAX_TOTAL, DEFAULTS.api.concurrency.maxTotal))
const queueSoftLimit = enforceBounds('API_QUEUE_SOFT_LIMIT', toInt(env.API_QUEUE_SOFT_LIMIT, DEFAULTS.api.concurrency.queueSoftLimit))
const allowedOutputFormats = parseFormatsStrict(env.IMAGE_ALLOWED_OUTPUT_FORMATS, knownFormats, knownFormats)
