...
PROJECT_ROOT="/Volumes/Knowledge/YYC-DCU/YYC3-QZ-Merchant-Management-System"
...
function performanceCheck() {
    ...
    // 检查node_modules大小
    const nodeModulesPath = '/Volumes/Knowledge/YYC-DCU/YYC3-QZ-Merchant-Management-System/node_modules';
    ...
    // 检查构建产物
    const nextPath = '/Volumes/Knowledge/YYC-DCU/YYC3-QZ-Merchant-Management-System/.next';
...
function securityCheck() {
    ...
    const projectPath = '/Volumes/Knowledge/YYC-DCU/YYC3-QZ-Merchant-Management-System';
