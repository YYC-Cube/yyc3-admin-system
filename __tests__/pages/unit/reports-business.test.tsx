/**
 * @file reports/business 页面测试
 * @description Reports 模块的页面功能测试
 * @category Reports
 * @priority MEDIUM
 * @author YYC
...
// 页面组件
import BusinessPage from '@/app/dashboard/reports/business/page';

// Mock 数据
const mockData = {
  pageData: require('./fixtures/reports/business.json'),
  userData: require('./fixtures/user.json'),
  authData: require('./fixtures/auth.json')
};

describe('reports/business 页面测试', () => {
  beforeEach(() => {
    // 设置测试环境
    jest.clearAllMocks();
