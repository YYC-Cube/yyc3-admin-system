/**
 * @file sales/orders 页面测试
 * @description Orders 模块的页面功能测试
 * @category Orders
 * @priority HIGH
 * @author YYC
...
// 页面组件
import OrdersPage from '@/app/dashboard/sales/orders/page';

// Mock 数据
const mockData = {
  pageData: require('./fixtures/sales/orders.json'),
  userData: require('./fixtures/user.json'),
  authData: require('./fixtures/auth.json')
};

describe('sales/orders 页面测试', () => {
  beforeEach(() => {
    // 设置测试环境
    jest.clearAllMocks();
