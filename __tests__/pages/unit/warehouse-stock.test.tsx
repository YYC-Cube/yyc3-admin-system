/**
 * @file warehouse/stock 页面测试
 * @description Warehouse 模块的页面功能测试
 * @category Warehouse
 * @priority MEDIUM
 * @author YYC
 * @created 2025-11-13T18:02:33.470Z
 */
...
// 页面组件
import StockPage from '@/app/dashboard/warehouse/stock/page';

// Mock 数据
const mockData = {
  pageData: require('./fixtures/warehouse/stock.json'),
  userData: require('./fixtures/user.json'),
  authData: require('./fixtures/auth.json')
};

describe('warehouse/stock 页面测试', () => {
  beforeEach(() => {
    // 设置测试环境
    jest.clearAllMocks();
