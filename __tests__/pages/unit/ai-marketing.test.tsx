/**
 * @file ai/marketing 页面测试
 * @description AI 模块的页面功能测试
 * @category AI
 * @priority MEDIUM
 * @author YYC
...
// 页面组件
import MarketingPage from '@/app/dashboard/ai/marketing/page';

// Mock 数据
const mockData = {
  pageData: require('./fixtures/ai/marketing.json'),
  userData: require('./fixtures/user.json'),
  authData: require('./fixtures/auth.json')
};

describe('ai/marketing 页面测试', () => {
  beforeEach(() => {
    // 设置测试环境
    jest.clearAllMocks();
