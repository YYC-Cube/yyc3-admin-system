/**
 * @file settings/store 页面测试
 * @description Settings 模块的页面功能测试
 * @category Settings
 * @priority LOW
 * @author YYC
...
// 页面组件
import StorePage from '@/app/dashboard/settings/store/page';

// Mock 数据
const mockData = {
  pageData: require('./fixtures/settings/store.json'),
  userData: require('./fixtures/user.json'),
  authData: require('./fixtures/auth.json')
};

describe('settings/store 页面测试', () => {
  beforeEach(() => {
    // 设置测试环境
    jest.clearAllMocks();
