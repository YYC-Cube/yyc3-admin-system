...
// 模拟组件 - 避免实际组件导入问题
const MockMobileApp = function MockComponent() {
  return (
    <div data-testid="mobile-app-container" className="min-h-screen">
      <header data-testid="page-header">
        <h1 data-testid="page-title">移动端页面测试</h1>
      </header>
      
      <main data-testid="page-content">
        <div data-testid="content-section">
          <p data-testid="welcome-message">欢迎使用移动端页面测试</p>
...
MockMobileApp.displayName = 'MockMobileApp';
...
describe('移动端页面测试', () => {
  ...
  test('页面应该正确渲染', () => {
    ...
    expect(screen.getByTestId('mobile-app-container')).toBeInTheDocument();
  ...
  test('响应式布局应该正常工作', () => {
    ...
    expect(screen.getByTestId('mobile-app-container')).toHaveClass('min-h-screen');
  });
});