/**
 * @file app/dashboard/members/page.tsx 快速测试
 * @description 测试会员信息和权益管理
 * @category Members
 * @priority HIGH
 * @author YYC
 * @created 2025-11-15T00:11:41.498Z
 */
...
let PageComponent;
try {
  PageComponent = require('@/app/dashboard/members/page').default;
} catch (error) {
  // 如果组件不存在，创建模拟组件
